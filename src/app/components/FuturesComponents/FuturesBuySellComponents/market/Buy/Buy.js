...
export default function MarketBuy({ userData, setError, otherInfo, orderLeverage }) {
            ...
            <div className="w-full h-full SkuuBit-DefaultContainer flex flex-col gap-6 bg-red-500">
                ...
                <button className="SkuuBit-BuyButton" onClick={
                    async () => {
                        ...
                        const newOrder = await OpenTrade(userData.uid, otherInfo + "USDT", quantityQuery, '', 'buy', 'market', 'open', orderLeverage, takeProfitPrice, stopLossPrice);
                        if (newOrder.result) {
