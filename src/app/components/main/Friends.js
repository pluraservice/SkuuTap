...
export default function Friends({ userData }) {
    ...
    return (
        <>
            <div className="w-full overflow-scroll p-4 gap-3">
                ...
                <div className="flex flex-col justify-center items-center gap-3 py-5 px-3">
                    ...
                    <ul class="w-full text-gray-300 flex flex-col py-2 gap-1">
                        ...
                        <div className="flex flex-col w-full gap-5 p-3" onClick={() => setCopyReferralUrl(true)}>
                            <h1 className="text-center truncate">https://www.skuubit.com/register?refCode={userData.uid}</h1>
                            <button className="w-auto h-auto px-5 py-2 flex gap-2 justify-center items-center rounded-xl" style={{ backgroundColor: "rgb(40, 40, 40)" }} onClick={
